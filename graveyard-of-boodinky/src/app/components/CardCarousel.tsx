    ...
    <section className="bg-slate-300" ref={ref}>
      <div className="relative overflow-hidden p-4">
        ...
        <div className="mx-auto max-w-6xl">
          <p className="mb-4 text-2xl text-slate-600 font-semibold">
            Game Clips
          </p>
          <motion.div
            animate={{
...
const Card = ({ url, category, title, description }: ItemType) => {
  return (
    <div
      className="relative shrink-0 cursor-pointer bg-slate-600 border-4 rounded-2xl border-emerald-500 shadow-md transition-all hover:scale-[1.015] hover:shadow-xl"
      style={{
        width: CARD_WIDTH,
        height: CARD_HEIGHT,
        marginRight: MARGIN,
